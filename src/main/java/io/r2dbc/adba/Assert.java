...
abstract class Assert {
    ...
    /**
     * Assert that the given String contains valid text content; that is, it must not be {@code null} and must contain at
     ...
     *                object's type will be appended. In any other case, a ":" with a space and the name of the offending
     ...
     * @param message   a message which will be prepended to provide further context. If it is empty or ends in ":" or ";"
     *                  or "," or ".", a full exception message will be appended. If it ends in a space, the name of the offending
     *                  sub type will be appended. In any other case, a ":" with a space and the name of the offending sub type
     *                  will be appended.
